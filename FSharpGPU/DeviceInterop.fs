...
module internal GeneralDeviceKernels = 
    ...
    let private map1ArgMaths cmpVal
        opFltV opFltA =
            match cmpVal with
    ...
    let reduceToEvenIndices (arr : ComputeArray) =
        ...
        |ComputeFloat ->
            ...
            ComputeArray(ComputeFloat, cudaPtr, len, FullArray, AutoGenerated)
        |_ -> raise <| System.NotSupportedException()
