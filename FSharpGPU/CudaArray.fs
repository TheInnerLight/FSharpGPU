...
module private DeviceArrayOps =
    ...
    let mapNeighbours (neighbourSpec : NeighbourMapping<'a,'b>) mapLengthSpec (inArray : devicearray<'a>) =
        ...
        // convert typeless result to typed device array
        devicearray<'b>(result)
    /// Reduction functions
