...
type DeviceArray =
    ...
    static member sum ([<ReflectedDefinition()>]) =
        DeviceArrayOps.TypedReductions.sumTotal <@ id : devicefloat @>
    ...
    static member average ([<ReflectedDefinition()>]) =
        DeviceArrayOps.TypedReductions.average <@ id : devicefloat @>
